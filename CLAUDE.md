...
| `POCKET_6K_G2 v8.6` | **Phase 3 in progress** (2026-07-30) — the current primary reference, and the live worked example of the firmware-upgrade variant below. Step 9 done; step 10 (active `dimension_enum` probing) next | `docs/recording.md` ("Per-camera status"), `docs/settings.md` §18, §18.7 |
