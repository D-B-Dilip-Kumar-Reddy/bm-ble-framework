"""
bmd_camera/ble/protocol/categories/recording.py
=========================================
...
``commands.recording.provenance`` and ``docs/ble/recording.md``). Real hardware
...
``0`` (SDI transport-mode semantics — see ``docs/ble/protocol.md`` §6). The
