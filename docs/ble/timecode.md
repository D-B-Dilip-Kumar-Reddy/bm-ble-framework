...
`src/bmd_camera/ble/timecode.py` decodes the `TIMECODE` characteristic and computes
...
## `Timecode` / `decode_timecode` (`src/bmd_camera/ble/timecode.py`)
...
`docs/ble/recording.md`): all 3 cycles reported `start timecode: 00:00:00:00`
